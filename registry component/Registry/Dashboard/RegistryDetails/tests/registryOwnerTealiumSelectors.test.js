/* eslint-disable */
import { getRegistryTeamliumInfo } from '../registryOwnerTealiumSelectors';
...
describe('Populating Registry Details on page load in Json Object for Tealium', () => {
  ...
  it("Page Load event for registry owner page 'getRegistryTeamliumInfo", () => {
    categoryBuckets = [
      {
    ...
    const route = {
      locationBeforeTransitions: {
        location: {
          pathname: 'viewRegistryOwner/home',
          search: '',
        },
        hash: '',
        key: '36nwmo',
    ...
    const expected = getRegistryTeamliumInfo(
      registryData,
      categoryBuckets,
      {
  ...
  it("Page Load event for registry owner page on myItems tab", () => {
    categoryBuckets = [
      {
        catSeoUrl: '/category/baby-kids/nursing-feeding/10570/',
        categoryId: '10570_NURSINGFEEDING',
    ...
    const route = {
      locationBeforeTransitions: {
        location: {
          pathname: 'viewRegistryOwner/myItems',
          search: '',
        },
        hash: '',
        key: '36nwmo',
  ...
  it("Page Load event for registry owner page on tym tab", () => {
    categoryBuckets = [
      {
        catSeoUrl: '/category/baby-kids/nursing-feeding/10570/',
        categoryId: '10570_NURSINGFEEDING',
    ...
    const route = {
      locationBeforeTransitions: {
        location: {
          pathname: 'viewRegistryOwner/tym',
          search: '',
        },
        hash: '',
        key: '36nwmo',
  ...
  it("Page Load event for registry owner page on recommendation tab", () => {
    categoryBuckets = [
      {
        catSeoUrl: '/category/baby-kids/nursing-feeding/10570/',
        categoryId: '10570_NURSINGFEEDING',
    ...
    const route = {
      locationBeforeTransitions: {
        location: {
          pathname: 'viewRegistryOwner/recommendation',
          search: '',
        },
        hash: '',
        key: '36nwmo',
  ...
  it("Page Load event for registry owner page when url has icid", () => {
    categoryBuckets = undefined;
    window.location.hash = '?icid=non-internal campaign';
    const route = {
      locationBeforeTransitions: {
        location: {
          pathname: '',
    ...
    expect(expected).to.deep.equal({
      ...
      crossell_product: 'non-cross sell',
      internal_search_term: 'non-search',
      product_finding_method: 'internal campaign',
      product_pagetype: '',
      product_id: [],
      product_sku_id: [],
      product_sku_name: [],
      ...
      product_sub_sub_category: [],
      subnavigation_path: 'Registry',
      internal_campaign: 'non-internal%20campaign',
      merchandising_main_level: 'non-browse',
      merchandising_category: 'non-browse',
      merchandising_subcategory: 'non-browse',
    });
  ...
  it("Page Load event for registry owner page 'getRegistryTeamliumInfo if certonaInfo is empty object", () => {
    categoryBuckets = [
      {
        catSeoUrl: '/category/baby-kids/nursing-feeding/10570/',
        categoryId: '10570_NURSINGFEEDING',
    ...
    const expected = getRegistryTeamliumInfo({
      ...
      crossell_product: 'non-cross sell',
      internal_search_term: 'non-search',
      product_finding_method: 'viewRegistryOwner/home',
      product_pagetype: '',
      product_id: [],
      product_sku_id: [],
      product_sku_name: [],
