...
import {
  ...
  renderNetworkInfo,
} from './EditOtherRegistryFormUtil';
import {
  registryInputFieldsOther,
  registryConfig,
  registryInputFieldsHouseWarming,
  registryInputFieldsCommitment,
  registryInputFieldsCollege,
...
const EditOtherRegistry = ({
  ...
  let registryInputFields;
  if (eventType === eventTypeConst.HOUSEWARMING) {
    registryInputFields = registryInputFieldsHouseWarming;
  } else if (eventType === eventTypeConst.COMMITMENT) {
    registryInputFields = registryInputFieldsCommitment;
  } else if (
    eventType === eventTypeConst.COLLEGE ||
    eventType === eventTypeConst.UNIVERSITY
  ) {
    registryInputFields = registryInputFieldsCollege;
  } else {
    registryInputFields = registryInputFieldsOther;
  }
  ...
  return (
    <React.Fragment>
      ...
      {renderEventInfo({
        ...
        isNewCreateRegForm: props.isNewCreateRegForm,
      })}
      {renderContactInfo({
        registryInputFields,
        labels,
...
EditOtherRegistry.propTypes = propTypes;

export default EditOtherRegistry;
