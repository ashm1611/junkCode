# `app/components/Pages/Registry/CreateRegistry/Components/FormComponents/test/ContactInfoV2.test.jsx`

#### `ContactInfo should be rendered correctly`
...
#### `mobileInfo should be rendered correctly`
